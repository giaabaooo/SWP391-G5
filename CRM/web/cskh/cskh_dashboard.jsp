...
<%-- 
    Sử dụng class 'content-wrapper' từ các file list của bạn 
    thay vì 'right-side' từ template index.html 
--%>
<div class="content-wrapper" style="background: #ffffff;">
    ...
    <section class="content">
        ...
        <%-- HÀNG 1: THẺ THỐNG KÊ (KPIs) - Dùng class 'stat-card' từ header2.jsp --%>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <%-- Biểu đồ (lấy từ template index.html) --%>
            ...
            <div class="col-md-4">
                <%-- Widget Feedback (dựa trên CSS 'activity-list') --%>
                <div class="content-card">
                    <div class="card-header">
                ...
                <div class="content-card">
                  ...
                  <div class="card-body" style="padding: 0;">
                    <div class="table-responsive">
                        <%-- Dùng class 'modern-table' từ header2.jsp --%>
...
<%-- 
  PHẦN SCRIPT
  Chúng ta cần script cho Chart.js (từ header2.jsp) và các plugin cơ bản
--%>
