                            ...
                            <div class="content-card">
                                ...
                                <form method="get" action="${pageContext.request.contextPath}/techmanager/task" >
                                    <div class="filter-bar">
                                        ...
                                        <a href="${pageContext.request.contextPath}/techmanager/task?action=list" class="btn btn-primary" style="background: #6c757d; border-color: #6c757d;"><i class="fa fa-times"></i>Clear</a>
