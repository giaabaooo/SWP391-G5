        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            <aside class="right-side">
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="color: #2d3748; font-weight: 600; margin-bottom: 0.5rem; margin-top: 0;">Updating...</h1>
                            <p style="color: #718096; margin-bottom: 2rem;">This function is under development please wait more</p>
                        </div>
                    </div>
