        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            <aside class="right-side">
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="color: #2d3748; font-weight: 600; margin-bottom: 0.5rem; margin-top: 0;">Reject Request</h1>
                            <p style="color: #718096; margin-bottom: 2rem;">Reject a request </p>
                        </div>
                    </div>
                            ...
                            <div class="card product-detail-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/techmanager/request">
                                        ...
                                        <div class="info-row">
                                            <div class="info-label">
                                                <i class="fa fa-calendar"></i> Request Date
                                            </div>
                                            <div class="info-row">
                                        ...
                                        <div class="info-row">
                                            <div class="info-label">
                                                <i class="fa fa-align-left"></i> Reject Reason
                                            </div>
                                            <div class="info-row">
                                                <textarea name="reason" style="width: 800px" rows="6" placeholder="Enter reject reason" required></textarea>
                                            </div>
                                        </div>

                                        <div class="mt-3 text-center" style="margin-top: 2rem;" >

                                            <a href="request" class="btn btn-default" style="min-width: 150px;">
                                                <i class="fa fa-arrow-left"></i> Back to List
                                            </a>
                                            <button type="submit" class="btn btn-danger" style="margin-right: 1rem; min-width: 150px;">
