        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            <aside class="right-side">
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="color: #2d3748; font-weight: 600; margin-bottom: 0.5rem; margin-top: 0;">Edit User Info</h1>
                            <p style="color: #718096; margin-bottom: 2rem;">Edit user information</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/admin/user?action=edit"
                                                ...
                                                <div class="tech-row" style="display:flex; align-items:center; gap:8px; margin-bottom:8px;">
                                                    <select name="roleId" class="form-control " required>
                                                        ...
                                                        <c:forEach var="t" items="${roleList}" >
                                                            <option value="${t.id}" <c:if test="${t.id == user.role.id}">selected</c:if> >${t.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group" style="margin-bottom: 1rem;">
                                            ...
                                            <input type="text" class="form-control" value="<c:out value="${user.address}" default="Not set"/>" readonly disabled>
                                            <small class="form-text text-muted" style="color: #718096; font-size: 12px;">Please re-select your full address below to update.</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="street" name="street" value="${streetDetail}" required>
                                        </div>              
