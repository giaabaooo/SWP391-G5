...
<%@ page import="data.ProductSerial" %>
            ...
            <aside class="right-side">
                <section class="content">
                    ...
                    <%
                        ...
                        List<ProductSerial> serials = (List<ProductSerial>) request.getAttribute("serials");
                        if (product != null) {
                    %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin-top: 20px;">
                            <div class="product-detail-card">
                                <div class="card-header">
                                    <h3><i class="fa fa-barcode"></i> Serial Numbers (${totalItems})</h3>
                                </div>
                                <div class="card-body" style="padding: 0;">
                                    ...
                                    <table class="table table-striped table-hover" style="margin-bottom: 0;">
                                        <thead>
                                            <tr>
                                                <th style="width: 10px; padding-left: 20px;">#</th>
                                                <th>Serial Number</th>
                                                <th style="width: 120px;">Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <% int count = ((Integer) request.getAttribute("page") - 1) * (Integer) request.getAttribute("pageSize") + 1; %>
                                    ...
                                    <div style="text-align: center; padding: 2rem;">
                                        <i class="fa fa-info-circle" style="font-size: 2rem; color: #718096; margin-bottom: 1rem;"></i>
                                        <p style="color: #718096; margin-bottom: 0;">No serial numbers found for this product.</p>
                                    </div>
                                    <% } %>
                                        ...
                                        <div class="pagination-container" style="padding: 15px 20px; border-top: 1px solid #f4f4f4;">
                                            ...
                                            <div class="pagination-controls">
                                                <button class="pagination-btn" ${page == 1 ? 'disabled' : ''}
                                                        onclick="window.location = '${pageContext.request.contextPath}/warestaff/viewProductDetail?id=${product.id}&page=${page - 1}'">
                                                    <i class="fa fa-angle-left"></i>
                                                </button>

                                                <button class="pagination-btn ${page == 1 ? 'active' : ''}"
                                                        onclick="window.location = '${pageContext.request.contextPath}/warestaff/viewProductDetail?id=${product.id}&page=1'">1</button>
                                                ...
                                                <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                                    <button class="pagination-btn ${i == page ? 'active' : ''}"
                                                            onclick="window.location = '${pageContext.request.contextPath}/warestaff/viewProductDetail?id=${product.id}&page=${i}'">${i}</button>
                                                </c:forEach>
                                                ...
                                                <c:if test="${totalPages > 1}">
                                                    <button class="pagination-btn ${page == totalPages ? 'active' : ''}"
                                                            onclick="window.location = '${pageContext.request.contextPath}/warestaff/viewProductDetail?id=${product.id}&page=${totalPages}'">${totalPages}</button>
                                                </c:if>
