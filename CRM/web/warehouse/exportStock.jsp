...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Warehouse | Stock Out</title>
                                ...
                                <div class="tab-content" style="padding:1.25rem;">
                                    ...
                                    <div class="tab-pane active" id="manualExport">
                                        ...
                                        <form method="post" action="<%= request.getContextPath()%>/warestaff/addExportTransaction" id="stockOutForm" novalidate>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label class="control-label">Export Type<span style="color:red">*</span></label>
                                                    <select name="exportType" class="form-control" required>
                                                        <option value="DELIVERED">Deliver to Customer</option>
                                                        <option value="WRITTEN_OFF">Write-off / Return</option>
                                                    </select>
                                                </div>
        ...
        <script>
            ...
            (function () {
                ...
                function attachRowHandlers(row) {
                    if (!row)
                        return;
                    row.querySelectorAll('.form-control').forEach(function (ctrl) {
                        ctrl.classList.remove('error');
                    });
                    row.querySelectorAll('.validation-error').forEach(function (err) {
                ...
                tableBody.querySelectorAll('.export-item-row').forEach(function (row) {
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    if (rows.length === 0) {
                        valid = false;
                        if (itemListError) {
                            itemListError.classList.add('show');
                        }
