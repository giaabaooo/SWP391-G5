...
<head>
    <meta charset="UTF-8">
    <title>Warehouse Staff | Edit Category</title>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <h1 style="color: #2d3748; font-weight: 600; margin-bottom: 0.5rem; margin-top: 0;">Edit Category</h1>
                    <p style="color: #718096; margin-bottom: 2rem;">Update category details</p>
                    <% Category category = (Category) request.getAttribute("category"); %>
                    <!-- Hiển thị lỗi trả về từ EditCategoryController -->
                ...
                <div class="col-md-12">
                    <div class="content-card">
                        <div class="card-header">
                            <h3><i class="fa fa-edit"></i> Category Information</h3>
                        </div>
                        <div class="card-body">
                            <!-- Form cập nhật thông tin danh mục -->
                            <form method="post" action="../warestaff/editCategory" novalidate>
                                ...
                                <div class="form-row">
                                    <div class="form-col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="categoryName" name="name" class="form-control<%= "Category name is required".equals(request.getAttribute("error")) ? " error" : "" %>" placeholder="Enter category name" required value="<%= category != null ? category.getName() : "" %>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox-container">
                                                <label class="checkbox-label">
                                                    <input type="checkbox" name="is_active" <%= category != null && category.isActive() ? "checked" : "" %> />
                                ...
                                <div class="form-row">
                                    <div class="form-col-full">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" rows="4" placeholder="Add an optional description"><%= category != null ? category.getDescription() : "" %></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script>
(function() {
  var form = document.querySelector('form[action="../warestaff/editCategory"]');
